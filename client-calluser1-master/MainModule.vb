...
Module MainModule
    ...
    Public Desks As Dictionary(Of String, Desk)
    Public Boxes As Dictionary(Of String, Box)
    Public BoxServiceDesks As Dictionary(Of Integer, BoxServiceDesk)
    ...
    Sub Main()
        ...
        If BoxServiceDesks IsNot Nothing Then
            BoxServiceDesks.Clear() : BoxServiceDesks = Nothing
        End If
    End Sub
